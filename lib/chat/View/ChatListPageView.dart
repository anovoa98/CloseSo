...
class _MyAppState extends State<ChatListPageView> {
  void response(query) async {
    AuthGoogle authGoogle = await AuthGoogle(
            fileJson: "assets/soclose-eddfe-4f18ed7a3f54.json")
        .build();
              ...
              children: <Widget>[
                CircleAvatar(
                  backgroundImage: AssetImage(
                      data == 0 ? "assets/images/person1.jpg" : "assets/images/person2.png"),
                ),
                SizedBox(
                  width: 10.0,
                ),
