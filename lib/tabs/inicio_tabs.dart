      ...
      child: FlipCard(
        ...
        front: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text('SoClose', style: Theme.of(context).textTheme.headline),
              Text('¡La mejor forma de encontrar a tus amigos!',
        ...
        back: Container(
          ...
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
              Text('¡BIENVENDIDO!', style: Theme.of(context).textTheme.headline, textAlign: TextAlign.center),
              Text('SoClose es una aplicación que te ayudara a encontrar a tus amigos en una ubicación determinada, más rápida y facilmente',
